const ChangeEmail = () => {
  ...
  return (
    <div style={containerStyle}>
      <h1 style={titleStyle}>Mudança de e-mail cadastrado</h1>
      ...
      <input type="text" placeholder="Email antigo" style={inputStyle} />
      <input type="text" placeholder="Email novo" style={inputStyle} />

      <p style={{ maxWidth: '450px', fontSize: '0.9rem', color: '#666', marginTop: '10px' }}>
        Mandar foto do seu documento e identidade com foto e CPF
      </p>
